...
; CATSTRIDER -- one scripted pseudo-3D flight for R800 + current V9968.
...
palette_upload:
    ...
    ; Data: 64 KiB linear background followed by 32 KiB Sprite3 atlas.
    ld a,8
    ld hl,0
...
render_sprites:
    ; 194a769 Sprite3 uses linear VRAM for attributes and SCREEN8 pixels.
    ; Linear CPU writes go directly to E000h/E400h, outside visible rows.
    ld a,(draw_page)
    add a,a
    add a,a
    add a,020h
...
registers:
    db 0,06h, 2,1Fh, 5,0C3h, 6,60h, 7,0, 8,08h, 9,80h
