LEGACY equ 0
VDP_BASE equ 152
; PRISM FLIGHT -- original V9968 visual warmup, runs from internal RAM.
; Internal V9968: ports 98h-9Ch. See ../../README.md.
    org 08000h
    jp entry
FRAME equ 0E000h
entry:
...
IF LEGACY
    ld a,07Fh               ; legacy register layout (inactive branch)
ELSE
...
init_regs:
    ...
    otir
    ; Background and sprite sheet: ROM banks4-11 -> VRAM20000-2FFFF.
    ld a,8
    ld hl,0
...
registers:
    db 0,06h, 2,1Fh, 5,03h, 6,50h, 7,0, 8,08h, 9,80h
    db 11,02h, 18,0, 19,0, 23,0, 25,0, 26,0, 27,0
    ; LRMM source window: X0..255, Y1024..1279.
    db 51,0, 52,0, 53,0, 54,4, 55,255, 56,0, 57,255, 58,4
registers_end:
sprite_end:
