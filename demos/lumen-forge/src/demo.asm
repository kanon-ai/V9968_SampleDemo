...
; Target: d884 V9968 openMSX. Mode-3 SAT planar handling is revision-specific.
    org 08000h
    jp entry
FRAME equ 0E000h
entry:
...
main_loop:
    ...
    ; d884 mode3 reads a physical contiguous SAT even in SCREEN8.
    ; Duplicate writes populate both physical planes at y224, outside display.
    ld a,(draw_page)
    add a,a
    add a,a
    add a,020h
...
registers:
    db 0,06h, 2,3Fh, 5,0C3h, 6,70h, 7,0, 8,08h, 9,80h
...
identity_vectors:
    dw 256,0
atlas_source_window:
    db 0,0, 0,5, 255,0, 127,5
primary_source_window:
    db 0,0, 0,5, 127,0, 127,5
secondary_source_window:
    db 128,0, 0,5, 191,0, 63,5
background_page0:
...
background_page1:
    ...
    db 0,0,030h
atlas_page0:
    dw 0,1280, 0,1792, 256,128
    db 0,080h,030h
atlas_page1:
    dw 0,1280, 0,1920, 256,128
    db 0,080h,030h
sprite_end:
