...
**2026-09-22 訂正:** 通常の `V9968` 新モードは未対応です。前回の `V9968_OLD` 検証は実機準拠対応ではありません。[新モードの検証結果](../../NEW-MODE-STATUS.md)を参照してください。 / Current-register mode has not passed validation.
